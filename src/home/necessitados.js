...
export function HomeNecessitados({ navigation }) {
  function cardsPessoa(value, index, array) {
    ...
    return (
      <TouchableOpacity
        ...
        style={style}
        onPress={() => {
          navigation.navigate("HelpNecessitados");
        }}
      >
        <Image
  ...
  function cardsOng(value, index, array) {
    ...
    return (
      <TouchableOpacity
        ...
        style={style}
        onPress={() => {
          navigation.navigate("HelpNecessitados2");
        }}
      >
        <Image
          style={{ width: 80, height: 80, top: 30, left: 30 }}
    ...
    <View style={styles.fundo}>
      <>
        ...
        <ScrollView contentContainerStyle={styles.boxWhite}>
          ...
          <TouchableOpacity
            onPress={() => {
              navigation.navigate("ProfileNecessitados");
            }}
          >
            <Image
